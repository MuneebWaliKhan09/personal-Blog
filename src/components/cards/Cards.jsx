    ...
    return (
        <>
            <div className={`flex justify-center  flex-wrap gap-12  my-10 p-4 `}>
                ...
                {
                    vissibleCards.map((d) => (
                        <div key={d.id} className="flex cardsbody overflow-hidden  gap-4 flex-col justify-center w-full max-w-[251px] mb-4 pb-1 border border-solid border-2 shadow-2xl  border-grey-600 rounded-xl">
