        ...
        {vissibleCards.map((d) => (
          ...
          >
            ...
            <div className="flex flex-col flex-grow gap-3 px-3 pb-3 ">
              ...
              <button
                className=" bg-gray-600 justify-items-end  hover:bg-gray-500 hover:transition transition-all  text-white font-bold py-2 px-4 rounded-full "
                onClick={() => handleNav(d?._id)}
              >
                See More
              </button>
            </div>
